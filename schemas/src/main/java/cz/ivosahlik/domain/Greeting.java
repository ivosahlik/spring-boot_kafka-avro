...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4109068881164020517L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"cz.ivosahlik.domain\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static cz.ivosahlik.domain.Greeting.Builder newBuilder() {
    return new cz.ivosahlik.domain.Greeting.Builder();
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static cz.ivosahlik.domain.Greeting.Builder newBuilder(cz.ivosahlik.domain.Greeting.Builder other) {
    if (other == null) {
      return new cz.ivosahlik.domain.Greeting.Builder();
    } else {
      return new cz.ivosahlik.domain.Greeting.Builder(other);
    }
  }
   ...
   * @return A new Greeting RecordBuilder
   */
  public static cz.ivosahlik.domain.Greeting.Builder newBuilder(cz.ivosahlik.domain.Greeting other) {
    if (other == null) {
      return new cz.ivosahlik.domain.Greeting.Builder();
    } else {
      return new cz.ivosahlik.domain.Greeting.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cz.ivosahlik.domain.Greeting.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cz.ivosahlik.domain.Greeting other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.Greeting.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.Greeting.Builder clearGreeting() {
      greeting = null;
