...
public class CoffeeUpdateEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1969139725071153816L;
...
static {
  ...
  @Deprecated public cz.ivosahlik.domain.generated.OrderStatus status;
   ...
   */
  public CoffeeUpdateEvent(java.util.UUID id, cz.ivosahlik.domain.generated.OrderStatus status) {
    this.id = id;
    this.status = status;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: status = (cz.ivosahlik.domain.generated.OrderStatus)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public cz.ivosahlik.domain.generated.OrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(cz.ivosahlik.domain.generated.OrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder newBuilder() {
    return new cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder();
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder newBuilder(cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder(other);
    }
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder newBuilder(cz.ivosahlik.domain.generated.CoffeeUpdateEvent other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeUpdateEvent>
    ...
    private cz.ivosahlik.domain.generated.OrderStatus status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.CoffeeUpdateEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder setStatus(cz.ivosahlik.domain.generated.OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.CoffeeUpdateEvent.Builder clearStatus() {
      status = null;
    ...
    public CoffeeUpdateEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[1] ? this.status : (cz.ivosahlik.domain.generated.OrderStatus) defaultValue(fields()[1]);
        return record;
