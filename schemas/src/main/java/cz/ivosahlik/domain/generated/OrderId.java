...
public class OrderId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8903424384750092723L;
   ...
   */
  public static cz.ivosahlik.domain.generated.OrderId.Builder newBuilder() {
    return new cz.ivosahlik.domain.generated.OrderId.Builder();
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.OrderId.Builder newBuilder(cz.ivosahlik.domain.generated.OrderId.Builder other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.OrderId.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.OrderId.Builder(other);
    }
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static cz.ivosahlik.domain.generated.OrderId.Builder newBuilder(cz.ivosahlik.domain.generated.OrderId other) {
    if (other == null) {
      return new cz.ivosahlik.domain.generated.OrderId.Builder();
    } else {
      return new cz.ivosahlik.domain.generated.OrderId.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.OrderId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cz.ivosahlik.domain.generated.OrderId other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.OrderId.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cz.ivosahlik.domain.generated.OrderId.Builder clearId() {
